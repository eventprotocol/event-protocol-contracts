...
contract('Event Token Unit Testing', async (accounts) => {
  ...
  it("Test 10: Expected allowances should be 1000 and 2000", async() => {
      ...
      assert.equal(allowance1.toNumber(), 1000, "The allowances for accounts[0] and accounts[1] do not match");
      assert.equal(allowance2.toNumber(), 2000, "The allowances for accounts[1] and accounts[2] do not match");
